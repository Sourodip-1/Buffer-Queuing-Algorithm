...
export default function LiveQueueTicket() {
  ...
  // Dynamic parameters with robust fallbacks
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: `Buffer Queue: I am holding Token ${tokenNumber} at ${venueName} (${branchName}). Estimated service time is ${estServiceTime}.`,
      });
    } catch {
        ...
        <View style={[styles.topSubBar, { justifyContent: 'flex-end' }]}>
          <View style={styles.subBarActions}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Alert.alert('Ticket Options', 'Live notifications and audio chimes are enabled.')
              }
              activeOpacity={0.7}
            >
        ...
        <View style={styles.mainContent}>
            ...
            <View style={styles.ticketCardHeader}>
              ...
              <View style={styles.ticketCardHeaderBottom}>
                ...
                <Text style={styles.branchDetails}>
                  <MaterialIcons name="table-restaurant" size={16} color={theme.colors.primary} />{' '}
                  {partySize} · {seatingPref}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.step}>
              ...
              <View style={styles.stepContentActive}>
                ...
                <Text style={styles.stepDesc}>
                  {aheadCount} parties ahead · Host pacing table clearing
                </Text>
              </View>
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                Alert.alert(
                  ...
                  `Call ${venueName} customer desk at +1 (555) 019-2834?`,
                  [
                    { text: 'Cancel', style: 'cancel' },
                    { text: 'Call Desk', onPress: () => {} },
                  ]
                )
              }
            >
          ...
          >
            ...
            <Text style={styles.syncText}>
              ...
              <Text style={styles.syncTextUnderline}>Tap to refresh</Text>
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
        ...
        >
          <Pressable style={styles.modalCard} onPress={(e) => e.stopPropagation()}>
            ...
            <Text style={styles.modalDescription}>
              You are currently {aheadCount === 1 ? '1st' : `${aheadCount}th`} in line. If you leave,
              you will have to re-register when you return.
            </Text>
            ...
            <View style={styles.modalActions}>
              ...
              >
                {isCancelling ? (
                  ...
                  <Text style={styles.confirmCancelText}>Yes, Cancel My Spot</Text>
                )}
              </TouchableOpacity>

              <TouchableOpacity
                style={styles.stayInLineBtn}
                disabled={isCancelling}
...
const styles = StyleSheet.create({
  ...
  ticketCardBody: {
    padding: theme.spacing.md,
    backgroundColor: theme.colors.primaryFixed + '4D',
    alignItems: 'center',
  },
  yourQueueToken: {
    fontSize: 12,
